...
public interface ListOfString {
   ...
   */
  public ListOfString add(int index, String s) throws IllegalArgumentException;
  ...
  /**
   * Return a list of strings that interleaves
   * the elements of this list and the other,

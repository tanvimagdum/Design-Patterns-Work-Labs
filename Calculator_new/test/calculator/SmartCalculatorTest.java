...
/**
 * A JUnit test class for Smart Calculator tests.
 */
...
public class SmartCalculatorTest {
  ...
  @Test
  public void testFirstCharOperatorPlus() {
    Calculator c2 = new SmartCalculator();
    c2.input('+');
    assertEquals("+", c2.getResult());
  }
  ...
  @Test
  public void testMultipleOperatorsAtTime1() {
    Calculator c2 = new SmartCalculator();
    c2.input('3');
  ...
  @Test
  public void testMultipleOperatorsAtTime2() {
    Calculator c2 = new SmartCalculator();
    c2.input('3');
    assertEquals("3",c2.getResult());
    c2.input('+');
  ...
  @Test
  public void testMultipleOperatorsAtTime3() {
    Calculator c2 = new SmartCalculator();
    c2.input('3');
    assertEquals("3",c2.getResult());
    c2.input('-');
  ...
  @Test
  public void testMultipleOperatorsAtTime4() {
    Calculator c2 = new SmartCalculator();
    c2.input('3');
    assertEquals("3",c2.getResult());
    c2.input('-');
  ...
  @Test
  public void testMultipleTimesEqualsAddition() {
    Calculator c2 = new SmartCalculator();
    c2.input('1');
    c2.input('0');
    c2.input('+');
    ...
    assertEquals("20", c2.getResult());
    c2.input('=');
    assertEquals("30", c2.getResult());
    c2.input('=');
    assertEquals("40", c2.getResult());

  }

  @Test
  public void testMultipleTimesEqualsSubtraction() {
    Calculator c2 = new SmartCalculator();
    c2.input('1');
    c2.input('0');
    c2.input('-');
  ...
  @Test
  public void testMultipleTimesEqualsMultiplication() {
    Calculator c2 = new SmartCalculator();
    c2.input('1');
    c2.input('0');
    c2.input('*');
    ...
    assertEquals("1000", c2.getResult());
    c2.input('=');
    assertEquals("10000", c2.getResult());
  }

  @Test
  public void testMultipleTimesEqualsAfterResultAddition() {
    Calculator c2 = new SmartCalculator();
    c2.input('1');
    c2.input('0');
    c2.input('+');
    ...
    assertEquals("12", c2.getResult());
    c2.input('=');
    assertEquals("14", c2.getResult());
    c2.input('=');
    assertEquals("16", c2.getResult());
  }

  @Test
  public void testMultipleTimesEqualsAfterResultSubtraction() {
    Calculator c2 = new SmartCalculator();
    c2.input('1');
    c2.input('0');
    c2.input('-');
  ...
  @Test
  public void testMultipleTimesEqualsAfterResultMultiplication() {
    Calculator c2 = new SmartCalculator();
    c2.input('1');
    c2.input('0');
    c2.input('*');
